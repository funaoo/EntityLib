...
final class FloatingTextEntity extends BaseEntity {
    ...
    protected function initEntity(CompoundTag $nbt): void {
        ...
        // Floating text is always invisible body, always-visible nametag, never collides or looks
        $this->setScale(0.01);
    ...
    // Unconditionally block these — floating text must never look or collide
